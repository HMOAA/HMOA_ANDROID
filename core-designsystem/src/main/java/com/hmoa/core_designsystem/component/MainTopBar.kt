            ...
            Row(modifier = Modifier.fillMaxWidth().background(color = Color.White), verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.SpaceBetween) {
                IconButton(
                    ...
                    Image(
                        ...
                        painter = painterResource(com.hmoa.core_designsystem.R.drawable.ic_drawer),
                ...
                Row {
                    IconButton(
                        ...
                        content = {
                            Image(
                                modifier = Modifier.size(25.dp),
                                painter = painterResource(com.hmoa.core_designsystem.R.drawable.ic_search),
                    ...
                    Column {
                        IconButton(
                            ...
                            content = {
                                Image(
                                    modifier = Modifier.size(25.dp),
                                    painter = painterResource(com.hmoa.core_designsystem.R.drawable.ic_bell),
