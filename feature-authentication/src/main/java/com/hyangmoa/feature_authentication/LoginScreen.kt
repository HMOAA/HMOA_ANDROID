package com.hyangmoa.feature_authentication
...
import com.hyangmoa.core_designsystem.component.OAuthLoginButton
import com.hyangmoa.core_designsystem.theme.CustomColor
import com.hyangmoa.core_model.Provider
import com.hyangmoa.feature_authentication.viewmodel.LoginUiState
import com.hyangmoa.feature_authentication.viewmodel.LoginViewModel
    ...
    Column(
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            Icon(
                ...
                painter = painterResource(com.hyangmoa.core_designsystem.R.drawable.ic_hmoa_logo),
                contentDescription = "OAuth Type Icon",
            )
            Spacer(modifier = Modifier.padding(top = 100.dp))
            OAuthLoginButton(
                backgroundColor = Color.White,
                iconId = com.hyangmoa.core_designsystem.R.mipmap.ic_google_foreground,
                iconSize = 40,
            ...
            OAuthLoginButton(
                ...
                iconId = com.hyangmoa.core_designsystem.R.drawable.ic_kakao,
                iconSize = 13,
