...
@Composable
fun HbtiRoute(onHbtiSurveyClick: () -> Unit, onAfterOrderClick: () -> Unit, onBackClick: () -> Unit) {
    HbtiScreen(
...
@Composable
fun HbtiScreen(onHbtiSurveyClick: () -> Unit, onAfterOrderClick: () -> Unit, onBackClick: () -> Unit) {
